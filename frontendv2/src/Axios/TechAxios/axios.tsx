...
const axiosInstancetech = createAxiosInstance({
  role: 'tech',
  baseURL: import.meta.env.VITE_TECH_PORT,
  tokenSelector: (state) => state.techtoken?.token,
  userSelector: (state) => state.tech?.tech,
  tokenAction: addtechtoken,
  clearUser: cleanTech,
  clearToken: cleartoken,
  idHeaderKey: 'tech-id',
  localStorageKey: 'techId',
});
