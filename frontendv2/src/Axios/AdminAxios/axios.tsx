...
const axiosInstanceadmin = createAxiosInstance({
  role: 'admin',
  baseURL: import.meta.env.VITE_ADMin_PORT,
  tokenSelector: (state) => state.admintoken?.token,
  userSelector: (state) => state.admin?.admin,
  tokenAction: addadmintoken,
  clearUser: cleanAdmin,
  clearToken: cleartoken,
  idHeaderKey: 'admin-id',
  localStorageKey: 'adminId',
});
