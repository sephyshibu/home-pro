...
router.post('/api/login',(req,res)=>adminController.login(req,res))
router.get('/api/fetchuser',authToken,(req,res)=>adminController.fetchuser(req,res))
router.post('/refresh',(req,res)=>adminController.refreshtokenController(req,res))
router.post('/api/addtech',authToken,(req,res)=>adminController.signuptech(req,res))
router.patch('/api/user/:userid',authToken,(req,res)=>adminController.blockUnblock(req,res))
router.get('/api/fetchtech',authToken,(req,res)=>adminController.fetchtech(req,res))
router.patch('/api/tech/:techid',authToken,(req,res)=>adminController.blockunblocktechs(req,res))
router.get('/api/fetchcategory',authToken,(req,res)=>adminController.fetchCategory(req,res))
router.post('/api/addcategory',authToken,(req,res)=>adminController.addcategorys(req,res))
router.patch('/api/category/:catid',authToken,(req,res)=>adminController.blockunblockcatagory(req,res))
router.patch('/api/editcategory/:catid',authToken,(req,res)=>adminController.editcategory(req,res))
router.get('/api/category/:catid',authToken,(req,res)=>adminController.fetchCategoryById(req,res))
router.get('/api/fetchtransactions',authToken,(req,res)=>adminController.fetchTransaction(req,res))
router.get('/api/fetchtransactionwithBookings/:transId',authToken,(req,res)=>adminController.transactionwithBookings(req,res))
router.get('/api/fetchrefundreqall',authToken,(req,res)=>adminController.fetchingrequestrefund(req,res))
router.post('/api/acceptrefund/:bookingId',authToken,(req,res)=>adminController.acceptingrefund(req,res))
router.get('/api/searchuser/:searchterm',authToken,(req,res)=>adminController.searchingUsers(req,res))
router.get('/api/searchtech/:searchterm',authToken,(req,res)=>adminController.searchingTech(req,res))
router.get('/api/searchcategory/:searchterm',authToken,(req,res)=>adminController.searchingCategory(req,res))
router.get('/api/searchbooking/:searchterm',authToken,(req,res)=>adminController.searchbookingtransaction(req,res))
