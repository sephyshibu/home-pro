...
const Signup = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center bg-[#0A1D56] relative overflow-hidden px-4", children: [_jsx("div", { className: "absolute -top-20 flex flex-col items-center z-10", children: _jsx("img", { src: logo, alt: "HomePro Logo", className: "w-80 h-39 mt-34" }) }), _jsxs("div", { className: "flex items-center justify-center gap-8 mt-32", children: [_jsx("div", { className: "hidden lg:block w-[280px] h-[380px] lg:w-[300px] lg:h-[400px]", children: _jsx("img", { src: one, alt: "Technician working", className: "rounded-lg shadow-lg object-cover w-full h-full" }) }), _jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-20 w-[400px] lg:w-[500px]", children: [_jsx("h2", { className: "text-2xl font-bold text-center text-[#0A1D56] mb-6", children: "USER SIGNUP" }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [_jsx("input", { type: "name", name: "name", placeholder: "Enter Username", value: formdata.name, onChange: handleChange, className: "w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00A9FF]" }), error.name && _jsx("p", { className: "text-red-500 text-center text-sm", children: error.name }), _jsx("input", { type: "email", name: "email", placeholder: "Enter Email", value: formdata.email, onChange: handleChange, className: "w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00A9FF]" }), error.email && _jsx("p", { className: "text-red-500 text-center text-sm", children: error.email }), _jsx("input", { type: "password", name: "password", placeholder: "Enter password", value: formdata.password, onChange: handleChange, className: "w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00A9FF]" }), error.password && _jsx("p", { className: "text-red-500 text-center text-sm", children: error.password }), _jsx("input", { type: "password", name: "confirmpassword", placeholder: "Enter Confirmpassword", value: formdata.confirmpassword, onChange: handleChange, className: "w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00A9FF]" }), error.confirmpassword && _jsx("p", { className: "text-red-500 text-center text-sm", children: error.confirmpassword }), _jsx("input", { type: "phone", name: "phone", placeholder: "Enter Phonenumber", value: formdata.phone, onChange: handleChange, className: "w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00A9FF]" }), error.phone && _jsx("p", { className: "text-red-500 text-center text-sm", children: error.phone }), _jsx("button", { type: "submit", disabled: loading, className: "w-full bg-[#00A9FF] hover:bg-[#008BD1] text-white font-semibold py-3 rounded-md transition duration-300 transform hover:scale-105", children: loading ? "Signing in..." : "SignUp" }), _jsx("div", { className: "text-center text-sm text-gray-600 mt-3", children: _jsx("a", { href: "/login", className: "hover:underline", children: "Already have account?" }) })] })] }), _jsx("div", { className: "hidden lg:block w-[280px] h-[380px] lg:w-[300px] lg:h-[400px]", children: _jsx("img", { src: two, alt: "Technician working", className: "rounded-lg shadow-lg object-cover w-full h-full" }) })] }), _jsx("div", { className: "absolute bottom-0 mb-4 flex flex-col items-center text-white text-xs", children: _jsx("p", { children: "\u00A9 2025 HomePro" }) })] }));
};
